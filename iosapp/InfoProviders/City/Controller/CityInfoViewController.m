...
@interface CityInfoViewController ()<GYZChooseCityDelegate>{
...
- (void)viewDidLoad {
    ...
    chooseCityBtn = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 500, 100)];
...
{
    [chooseCityBtn setTitle: [NSString stringWithFormat:@"%@ %@",city.cityName, city.cityID] forState:UIControlStateNormal];
