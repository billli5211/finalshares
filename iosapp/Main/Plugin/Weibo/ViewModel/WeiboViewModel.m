...
-(void) weiboDetailWithPublicModel: (WeiboModel *) publicModel WithViewController:(UIViewController *)superController
{
    ...
    WeiboDetailViewController *detailController = [storyboard instantiateViewControllerWithIdentifier:@"WeiboDetailViewController"];
